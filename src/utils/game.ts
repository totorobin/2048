...
export const useGame = () => {
    ...
    const move = (direction: 'up' | 'down' | 'left' | 'right') => {
        ...
        switch (direction) {
            case 'up':
                theGame.value.grille = moveUp(theGame.value?.grille);
                break;
            case "down":
                theGame.value.grille = moveDown(theGame.value?.grille);
                break;
            case "left":
                theGame.value.grille = moveLeft(theGame.value?.grille);
                break;
            case "right":
                theGame.value.grille = moveRight(theGame.value?.grille);
                break;
        }
