...
import {useMagicKeys, useStorage, useSwipe} from "@vueuse/core";
...
<template>
  <div ref="game" class="container">
    <h1>2048</h1>
    <div class="score-container">
      <div class="score-box">
        <div class="label">SCORE</div>
        <div class="value">{{ gameStore.points }}</div>
      </div>
      <div class="score-box">
    ...
    <div class="grid-container">
      <div v-for="cell in gridAsList" :class="`tile-${cell}`" class="grid-cell">{{ cell == 0 ? '' : cell }}</div>
    </div>
    {{ direction }}
  </div>
</template>
